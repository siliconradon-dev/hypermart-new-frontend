...
function DailySummary() {
  ...
  const exportTableToPDF = () => {
    const table = document.getElementById('DailySummary');
    ...
    form.method = 'POST';
    form.action = 'https://hypermart-new.onlinesytems.com/print/daily-summary';
    form.target = '_blank';
  ...
  const resetReport = () => {
    window.location.href = '/reports/dailySummary';
  };
  ...
  return (
    <div className="daily-summary-page min-h-dvh max-lg:h-fit flex flex-col h-dvh">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <p className="text-sm font-medium text-gray-700 ms-1 md:ms-2">Daily Summary Report</p>
              </div>
            </li>
          </ol>
      ...
      <div className="px-12 max-sm:px-6">
        <form onSubmit={(event) => {
          ...
          <div className="grid gap-4 py-4 md:grid-cols-5">
            <div>
              <label htmlFor="date" className="block mb-1 text-xs font-medium text-black">Date</label>
              <input
                id="date"
                name="date"
                type="date"
            ...
            <div className="flex justify-start gap-4 md:col-span-1">
      ...
      <div className="flex flex-col px-12 py-5 overflow-y-auto bg-white max-sm:px-6 max-lg:min-h-full">
        <div className="relative h-[500px] overflow-x-auto">
          <table id="DailySummary" className="w-full text-sm text-left text-gray-500">
