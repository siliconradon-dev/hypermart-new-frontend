...
const PaymentMachines = () => {
  ...
  return (
    <div className="payment-machines-page min-h-dvh max-lg:h-fit flex flex-col h-dvh">
      ...
      <div className="flex flex-col h-[85%]">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-2">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-500 ms-1 md:ms-2">Payment Machines</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="flex-1 px-4 pb-6 overflow-auto sm:px-6 lg:px-12">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-2xl font-bold text-gray-900">Payment Machines</h1>
            <a href="/finance/payment-machines/create" className="px-4 py-2 text-white rounded-lg bg-[#3c8c2c] hover:opacity-90">
              <i className="mr-2 fas fa-plus" />Add New Machine
            </a>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="text-xs text-white uppercase bg-[#3c8c2c]">
                <tr>
                  ...
                  <th className="px-4 py-2">Connected Bank Account</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td colSpan="6" className="px-6 py-4 text-center text-gray-500">No payment machines found</td>
                </tr>
              </tbody>
            </table>
          </div>
