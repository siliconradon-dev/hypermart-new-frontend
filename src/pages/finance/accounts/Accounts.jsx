...
const Accounts = () => {
  ...
  return (
    <div className="accounts-page min-h-dvh max-lg:h-fit flex flex-col h-dvh">
      ...
      <div className="flex flex-col h-[85%]">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-2">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-medium text-gray-500 ms-1 md:ms-2">Bank Accounts</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="flex-1 px-4 pb-6 overflow-auto sm:px-6 lg:px-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/finance/accounts/create" className="px-4 py-2 text-white rounded-lg bg-[#3c8c2c] hover:opacity-90">
              <i className="mr-2 fas fa-plus" />Add New Account
            </a>
          </div>
          ...
          <div className="p-6 mb-6 bg-white rounded-lg shadow">
            <form className="grid grid-cols-1 gap-4 md:grid-cols-5">
              ...
              <div>
                ...
                <select name="bank_id" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
              ...
              <div>
                ...
                <select name="account_type" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
              ...
              <div className="flex items-end space-x-2">
                ...
                <a href="/finance/accounts" className="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
          ...
          <div className="overflow-auto bg-white rounded-lg shadow">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td colSpan="8" className="px-6 py-4 text-center text-gray-500">No bank accounts found</td>
                </tr>
              </tbody>
            </table>
          </div>
